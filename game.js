...
// }
// function handleRectangleCollision(rectangle, target) {
//   if (!target.disableControl) {
//     // Устанавливаем флаг и направляем target вправо с ускорением
//     target.disableControl = true;
//     target.body.setVelocity(600, 0); // Задаем ускорение вправо

//     // Отключаем любую текущую логику поиска зрителей для target
//     if (target === circleBody) {
//       circleBodySearching = false; // Например, переменная, управляющая поиском зрителей
//     }
//   }
// }
function handleRectangleCollision(rectangle, target) {
